...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, LED_R_Pin|TEST_2_Pin|TEST_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : PB_NUCLEO_Pin */
  GPIO_InitStruct.Pin = PB_NUCLEO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PB_NUCLEO_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : TEST_2_Pin TEST_1_Pin */
  GPIO_InitStruct.Pin = TEST_2_Pin|TEST_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
